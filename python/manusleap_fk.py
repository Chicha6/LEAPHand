...
class LeapNode:
    def __init__(self):
        ...
        # Index  -> 1: MCP side, 0: MCP flex, 2: Pip flex, 3: Dip flex
        # Middle -> 5: MCP side, 4: MCP flex, 6: Pip flex, 7: Dip flex
        # THumb  -> 9: MCP side, 8: MCP flex, 10: Pip flex, 11: Dip flex
